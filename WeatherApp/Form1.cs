...
namespace WeatherApp
{
    public partial class Form1 : Form
    {
        ...
        string APIKey = "17b3d277dba913ac69fabfc6477da2b6";
        ...
        private void getWeather()
        {
            using (WebClient web = new WebClient())
            {
                ...
                double pressureInHpa = Info.main.pressure / 100.0;
                lab_pressure.Text = $"{pressureInHpa:F2} hPa";

                double windSpeedInKmPerHour = Info.wind.speed * 3.6;
                lab_windspeed.Text = $"{windSpeedInKmPerHour:F2} km/h";

                double temperatureInCelsius = Info.main.temp - 273.15;
                lab_temp.Text = $"{temperatureInCelsius:F2} °C";
            }
